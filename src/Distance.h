#ifndef FORTRANLINALGDISTANCES_H
#define FORTRANLINALGDISTANCES_H
...
class Distance{
  ...
  public:
    static FortranLinalg::DenseMatrix<TPrecision> computeDistances(FortranLinalg::Matrix<TPrecision> &data, 
                                                    FortranLinalg::Metric<TPrecision> &metric){
    ...
    static void computeKNN(FortranLinalg::Matrix<TPrecision> &data, FortranLinalg::Matrix<int> &knn,
        FortranLinalg::Matrix<TPrecision> &dists, FortranLinalg::Metric<TPrecision> &metric){
    ...
    static void computeKNN(FortranLinalg::Matrix<TPrecision> &data, int index,
        FortranLinalg::Vector<int> &knn, FortranLinalg::Vector<TPrecision> &dists, FortranLinalg::Metric<TPrecision> &metric){
    ...
    static void computeKNN(FortranLinalg::Matrix<TPrecision> &data,
        ...
        FortranLinalg::Vector<TPrecision> &dists, FortranLinalg::Metric<TPrecision> &metric){
