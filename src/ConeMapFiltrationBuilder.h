...
#ifndef CONEMAPFILTRATIONBUILDER_H
#define CONEMAPFILTRATIONBUILDER_H
...
class ConeMapFiltrationBuilder{
  ...
  public:
    ...
    void run( Neighbors &N, TPrecision minTime, TPrecision maxTime,
              unsigned int maxSize, int maxD, int scale){
